    ...
    <section className="relative overflow-hidden py-10 md:py-14">
      ...
      >
        ...
        <p className="mt-6 text-lg text-white/90 max-w-3xl mx-auto">
          CodeMentor AI helps you learn real-world development, build
          industry-grade projects, and unlock opportunities in jobs,
        ...
        >
          Trusted by{" "}
          <span className="font-semibold text-white">500+ clients</span> • 4+
